...
to import-python
  py:setup "C:/ProgramData/Anaconda3/python.exe"
  py:run "import util"
end
...
to reporter
  set unemployment_rate count workers with [employed = False] / count workers
...
firm_size_list
firm_size_list
"[1 2 5 10 20 40 50 90 100]" "[40 50 60]" "[1 2 5 10]"
0
